    ...
    return (
      <div className='getting-started__footer'>
        <ul>
          ...
          <li><a href='/privacy-policy' target='_blank'><FormattedMessage id='getting_started.privacy_policy' defaultMessage='Privacy aaaPolicy' /></a> · </li>
          <li><a href='/transactions' target='_blank'><FormattedMessage id='getting_started.transactions' defaultMessage='Transactions' /></a> · </li>
