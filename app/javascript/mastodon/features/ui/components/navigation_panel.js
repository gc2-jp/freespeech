...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    {/* <NavLink className='column-link column-link--transparent' to='/livechat' data-preview-title-id='column.livechat' data-preview-icon='address-card'><Icon className='column-link__icon' id='address-card' fixedWidth /><FormattedMessage id='navigation_bar.livechat' defaultMessage='LiveChat' /></NavLink> */}
    ...
    <a className='column-link column-link--transparent' href='/point_management'><Icon className='column-link__icon' id='credit-card-alt' fixedWidth /><FormattedMessage id='navigation_bar.point_management' defaultMessage='Point management' /></a>
