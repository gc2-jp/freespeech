...
ActiveRecord::Schema.define(version: 2023_02_01_044418) do
  ...
  create_table "gc2_point_users", force: :cascade do |t|
    t.bigint "user_id"
    t.string "customer_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_gc2_point_users_on_user_id"
  end
